 ...
 * more about this!
 */
const char MyName[] = "HenriqueNeffa";

/* Change these constants to contain the paths out of your mazes. */

// Value after mapping visually the maze
const char ThePathOutOfMyMaze[] = "ESWSNESSWENNEESWS";
const char ThePathOutOfMyTwistyMaze[] = "EESSWSESNEWE";
